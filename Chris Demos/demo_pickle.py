...
#with open(r"C:\Project\Python_Labs_Nov26\Chris Demos\movies.p", mode="wb") as fh_out:
with gzip.open(r"C:\Project\Python_Labs_Nov26\Chris Demos\movies.pgz", mode="wb") as fh_out:
    #pickle.dump(movies, fh_out, protocol=0) # Pickle Protocol (0=ASCII, 1-5=BINARY)
...
#
# with open(r"C:\Project\Python_Labs_Nov26\Chris Demos\movies.p", mode="rb") as fh_in:
with gzip.open(r"C:\Project\Python_Labs_Nov26\Chris Demos\movies.pgz", mode="rb") as fh_in:
